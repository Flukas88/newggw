...
func Test_getCityInfo(t *testing.T) {
	var milanC srv.CityTemp
	var milanF srv.CityTemp
	...
	tt := []struct {
		name     string
		expected srv.CityTemp
		got      srv.CityTemp
	}{
		{"Milan, C", srv.CityTemp{City: "Milan", Temp: "30.0", Degrees: "C"}, milanC},
		{"Milan, F", srv.CityTemp{City: "Milan", Temp: "62.1", Degrees: "F"}, milanF},
	}
	for _, tc := range tt {
